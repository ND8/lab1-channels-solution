...
//The Startup.java class will serve as a simple Java SE
//application – complete with a main( ) method. This class will be executed when
//the Spring Integration application is to run.
